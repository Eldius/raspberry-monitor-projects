...
import (
	...
	"github.com/Eldius/raspberry-monitor-projects/raspberry-simplemqtt-listener/client"
...
var rootCmd = &cobra.Command{
	Use:   "raspberry-simplemqtt-listener",
...
to quickly create a Cobra application.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		client.Subscribe(user, pass, host, port)
	},
}
...
func initConfig() {
	if cfgFile != "" {
		...
		appName := "simple-client"
		// Search config in home directory with name ".raspberry-simplemqtt-listener" (without extension).
