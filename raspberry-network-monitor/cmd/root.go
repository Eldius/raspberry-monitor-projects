...
var rootCmd = &cobra.Command{
	Use:   "network-monitor",
	Short: "A simple network monitor tool",
	Long:  `A simple network monitor tool.`,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.raspberry-network-monitor.yaml)")
